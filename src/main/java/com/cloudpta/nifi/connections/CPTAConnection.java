 ...
 * @author Danny
 */
public class CPTAConnection extends CPTANifiStorableObject<CPTAConnectionComponent>
{
    public CPTAConnection() throws CPTAException
    {
        super();
        component = new CPTAConnectionComponent();
    }
    @Override
    protected String getPersistSubURL()
    {
        return CPTANifiConstants.NIFI_API_PROCESS_GROUPS_SUBURL + "/" + component.getProcessGroupID() + "/connections";
    }
